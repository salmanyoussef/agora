...
class SynthesisSignature(dspy.Signature):
    ...
    - Note: The user is NOTTTTTTT the one who supplied to you the information based on the French open government datasets. The AGORA PIPELINE - created by me, the developer, and in which you are the last step - is the one who did the research and provided you with the relevant information.
